...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($newPassword !== $confirmPassword) {
        ...
        $checkStmt->bind_param("s", $userid); // Use "s" for string
        $checkStmt->execute();
        ...
        if ($checkResult->num_rows > 0) {
            ...
            $updateStmt->bind_param("ss", $hashedNewPassword, $userid); // Use "ss" for two strings
    ...
    <div class="forgot-container">
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <div class="form-group">
                ...
                <input type="text" id="userid" name="userid" required> <!-- Changed to type="text" -->
            </div>
            <div class="form-group">
